    ...
    <div className="page">
      ...
      <div className="dashboard-body">
        <div className="card profile-card">
          ...
          <button className="dashboard-action-btn">VIEW ALL REPORTS</button>
        </div>

        <div className="card stats-card">
          <div className="stats-title">Reports Statistics</div>
          <div className="stats-subtitle">All time fixed reports: 0</div>
          ...
          <div className="report-list">
            {REPORTS.map((r) => (
              <div key={r.id} className="report-row" onClick={() => onNavigate("adminTask")}>
